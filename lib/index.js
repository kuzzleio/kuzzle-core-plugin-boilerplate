 ...
 *
 * @see https://docs.kuzzle.io/plugins/1/essentials/plugin-layout/prerequis/Prerequis/
 */
class CorePlugin {
   ...
   *
   * @see https://docs.kuzzle.io/plugins/1/essentials/plugin-layout/prerequis/Prerequis/
   * @see https://docs.kuzzle.io/plugins/1/essentials/plugin-layout/config/Config/
   * @see https://docs.kuzzle.io/plugins/1/essentials/plugin-layout/init-fonction/Init%20fonction/
   */
