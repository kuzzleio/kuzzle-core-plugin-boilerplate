...
class CorePlugin {
  ...
  */
   ...
   * The SDK allow to interact with Kuzzle API in a much more pleasant way than using the context.accessors.execute method.
   *
   * This controller action simply get a document from Kuzzle.
