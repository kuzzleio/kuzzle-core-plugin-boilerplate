 ...
 *
 * @see https://docs.kuzzle.io/plugins/1/plugin-layout/prerequis/
 */
class CorePlugin {
  ...
  constructor() {
     ...
     * @type {Object}
     *
     * @see https://docs.kuzzle.io/plugins/1/essentials/hooks/
     * @see https://docs.kuzzle.io/plugins/1/events/intro/
     */
    this.hooks = {
     ...
     * @type {Object}
     *
     * @see https://docs.kuzzle.io/plugins/1/essentials/pipes/
     * @see https://docs.kuzzle.io/plugins/1/events/intro/
     */
    this.pipes = {
     ...
     * @type {Object}
     *
     * @see https://docs.kuzzle.io/plugins/1/essentials/controllers/
     */
    this.controllers = {
      myNewController: {
    ...
    this.routes = [
      {
        verb: 'get',
        url: '/say-something/:property',
        controller: 'myNewController',
        action: 'myNewAction'
      },
      {
        verb: 'get',
        url: '/get-document/:documentId',
        controller: 'myNewController',
        action: 'getDocument'
      }
    ];
     ...
     * @type {Array}
     *
     * @see https://docs.kuzzle.io/plugins/1/essentials/strategies/
     * @see https://docs.kuzzle.io/guide/1/essentials/user-authentication/
     */
    this.authenticators = {
   ...
   *
   * @see https://docs.kuzzle.io/plugins/1/plugin-layout/prerequis/
   * @see https://docs.kuzzle.io/plugins/1/plugin-layout/config/
   * @see https://docs.kuzzle.io/plugins/1/plugin-layout/init-function/
   */
  ...
  asyncListener(request) {
    ...
    console.log(
      `hook action ${request.input.action} on document ${
   ...
   *
   * @see https://docs.kuzzle.io/plugins/1/pipes/
   * @see https://docs.kuzzle.io/guide/1/essentials/request-and-response-format/
   */
  syncListener(request, callback) {
    // Your code here, for example...
    console.log(
      `pipe action ${request.input.action} on document ${
        request.input.resource._id
      }`
    );
   ...
   *
   * @see https://docs.kuzzle.io/plugins/1/controllers/
   * @see https://docs.kuzzle.io/guide/1/essentials/request-and-response-format/
   */
  async saySomething(request) {
    ...
    console.log(
      `controller myNewController action myNewAction param ${property}`
    );
   ...
   *
   *
   * @see the SDK JS 6 README for more informations https://github.com/kuzzleio/sdk-javascript/
   */
  async getDocument(request) {
    const index = request.input.args.indexName,
      collection = request.input.args.collectionName,
      documentId = request.input.args.documentId;

    const response = await this.context.accessors.sdk.document.get(
      index,
      collection,
      documentId
    );
   ...
   *
   * @see https://docs.kuzzle.io/plugins/1/strategies/
   */
