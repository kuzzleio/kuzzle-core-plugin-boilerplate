 ...
 * @deprecated  - If no `manifest.json` file is found, Kuzzle will falls back
...
class CorePlugin {
  ...
  */
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  create (request, credentials, kuid, strategyName) {
    // persist credentials
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  delete (request, kuid, strategyName) {
    // remove credentials
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  exists (request, kuid, strategyName) {
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  getInfo (request, kuid, strategyName) {
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  getById (request, id, strategyName) {
    // retrieve credentials
    return Promise.resolve(/* non sensitive credentials info */);
  }
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  update (request, credentials, kuid, strategyName) {
    // update credentials
    return Promise.resolve(/* non sensitive credentials info */);
  }
   ...
   * @see https://docs.kuzzle.io/plugins-reference/plugins-features/adding-authentication-strategy/
   */
  validate (request, credentials, kuid, strategyName, isUpdate) {
